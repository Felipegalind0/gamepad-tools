...
Prepared 2026-09-13. This replaces the earlier Gamepad Studio fork/port prompt. The companion findings are [gamepad-tools-research.md](integration-research.md).
